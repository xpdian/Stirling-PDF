...
//        if (apiKey == null) {
//            return ResponseEntity.status(HttpStatus.NOT_FOUND).body("API key not found for
// user.");
//        }
...
//    }
//
//    private static final String LOGIN_MESSAGETYPE_CREDSUPDATED =
// "/login?messageType=credsUpdated";
// }
